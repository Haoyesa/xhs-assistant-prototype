...
const CHANGELOG = [
  ...
  { v: '0.2.20', date: '2026-07-25', note: '本地图片文件夹导入结合千帆商品库：文件夹名支持 <商品ID>_<序号> 格式（如 686673d41ea4cb001553c6da_1），扫描时自动解析出商品ID并在千帆商品库中匹配，匹配成功则用商品名替换文件夹名作为笔记标题和 AI 文案种子；扫描结果卡片显示「🔗 已匹配千帆商品」标记与商品名；未匹配到则回退到文件夹名/name.txt 作为种子。' },
